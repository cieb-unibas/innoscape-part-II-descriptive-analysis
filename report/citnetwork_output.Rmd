...
# Input panels for continent(group) and year
  ...
  sliderInput("p_year_citing", "Year of citation", min=1990, max=2015, value=1990, sep="")
...
#Data preparation,labeling and initial filtering
  ...
  citflow_ctry <- citflow_ctry %>% 
    ...
    summarise(share_inv_cited = sum(share_inv_cited[tech_field_cited!="16"])) # Agregation summing, without cited pharma patents
