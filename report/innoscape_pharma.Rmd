...
# Load trade data
tradedata <- readRDS("oecd_trade_ch_final.rds")
tradedata <- filter(tradedata, value > 0.01 & variable != "val_export" | variable == "val_export" & value > 1000)
...
volumes <- mutate(volumes, ctry = countrycode(par.code, "iso3c", "country.name.en")) 
...
# Create the world map:
  ...
  map_world <- map_world[seq(1, nrow(map_world), 15), ]
  # map_world <- filter(map_world, region %in% unique(volumes$ctry))
