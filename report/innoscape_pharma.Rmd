...
<details>
  <summary style="font-size:11pt">*Click here for details about the data used*</summary>

* **Figure I: Steady increase of pharmaceutical job**: Data are taken from <a href = https://ilostat.ilo.org/data/ target = “_blank”>ILOSTAT</a> database. Employment data comes from the local labor force surveys which cover only the resident population. This means that the employment figures do not cover cross-border commuters. In addition, given that an employed person may hold several jobs the employment refers to his or her primary job only. Finally, this data covers all persons of working age who, during a specified brief period, were either in paid employment or self-employed.
