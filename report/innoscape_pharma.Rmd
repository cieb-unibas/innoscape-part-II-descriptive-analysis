...
dat_ii <- filter(dat_ii, ipc_3 == "all")
...
actionButton('geo_share', "Absolute value / relative to all patents")
geo_share <- eventReactive(input$geo_share,{
ifelse(input$geo_share %in% c(0, seq(2, 1000, 2)), "abs", "rel")}, ignoreNULL = FALSE)
